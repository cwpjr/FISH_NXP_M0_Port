...
#ifndef __IOLPC1100LX_H
#define __IOLPC1100LX_H
 ...
 ***************************************************************************
 **
 **    LPC1100LX SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
 ***************************************************************************
 ***************************************************************************/
...
#define STARTRSRP0CLR_RSRPIO0_0		(1UL << 0)
#define STARTRSRP0CLR_RSRPIO0_1		(1UL << 1)
#define STARTRSRP0CLR_RSRPIO0_2		(1UL << 2)
#define STARTRSRP0CLR_RSRPIO0_3		(1UL << 3)
#define STARTRSRP0CLR_RSRPIO0_4		(1UL << 4)
#define STARTRSRP0CLR_RSRPIO0_5		(1UL << 5)
#define STARTRSRP0CLR_RSRPIO0_6		(1UL << 6)
#define STARTRSRP0CLR_RSRPIO0_7		(1UL << 7)
#define STARTRSRP0CLR_RSRPIO0_8		(1UL << 8)
#define STARTRSRP0CLR_RSRPIO0_9		(1UL << 9)
#define STARTRSRP0CLR_RSRPIO0_10	(1UL <<10)
#define STARTRSRP0CLR_RSRPIO0_11	(1UL <<11)
#define STARTRSRP0CLR_RSRPIO1_0		(1UL <<12)
...
/* IOCON SSEL1 location register */
typedef struct {
  __REG32  SSEL1LOC       : 2;
  __REG32                 :30;
} __iocon_ssel1_loc_bits;
...
/* IOCON CT16B0_CAP0 location register */
typedef struct {
  __REG32  CT16B0_CAP0LOC : 2;
  __REG32                 :30;
} __iocon_ct16b0_cap0_loc_bits;

/* IOCON SCK1 location register */
typedef struct {
  __REG32  SCK1LOC 				: 2;
  __REG32                 :30;
} __iocon_sck1_loc_bits;

/* IOCON MISO1 location register */
typedef struct {
  __REG32  MISO1LOC				: 2;
  __REG32                 :30;
} __iocon_miso1_loc_bits;

/* IOCON MOSI1 location register */
typedef struct {
  __REG32  MOSI1LOC				: 2;
  __REG32                 :30;
} __iocon_mosi1_loc_bits;

/* IOCON CT32B0_CAP0 location register */
typedef struct {
  __REG32  CT32B0_CAP0LOC	: 2;
  __REG32                 :30;
} __iocon_ct32b0_cap0_loc_bits;

/* IOCON RXD location register */
typedef struct {
  __REG32  RXDLOC					: 2;
  __REG32                 :30;
} __iocon_rxd_loc_bits;
...
#define I2CMMCTRL_AAC		(0x00000004ul)
#define I2CMMCTRL_SIC		(0x00000008ul)
#define I2CMMCTRL_STAC	(0x00000020ul)
#define I2CMMCTRL_I2ENC	(0x00000040ul)
...
__IO_REG32_BIT(SYSRESSTAT,            0x40048030,__READ_WRITE ,__sysresstat_bits);
...
__IO_REG32(		 STARTRSRP0CLR,         0x40048208,__WRITE      );
...
__IO_REG32_BIT(IOCON_SSEL1_LOC,       0x40044018,__READ_WRITE ,__iocon_ssel1_loc_bits);
...
__IO_REG32_BIT(IOCON_CT16B0_CAP0_LOC, 0x400440C0,__READ_WRITE ,__iocon_ct16b0_cap0_loc_bits);
__IO_REG32_BIT(IOCON_SCK1_LOC,        0x400440C4,__READ_WRITE ,__iocon_sck1_loc_bits);
__IO_REG32_BIT(IOCON_MISO1_LOC,       0x400440C8,__READ_WRITE ,__iocon_miso1_loc_bits);
__IO_REG32_BIT(IOCON_MOSI1_LOC,       0x400440CC,__READ_WRITE ,__iocon_mosi1_loc_bits);
__IO_REG32_BIT(IOCON_CT32B0_CAP0_LOC, 0x400440D0,__READ_WRITE ,__iocon_ct32b0_cap0_loc_bits);
__IO_REG32_BIT(IOCON_RXD_LOC, 				0x400440D4,__READ_WRITE ,__iocon_rxd_loc_bits);
...
__IO_REG32(		 GPIO0IC,               0x5000801C,__WRITE      );
...
__IO_REG32(		 GPIO1IC,               0x5001801C,__WRITE      );
...
__IO_REG32(		 GPIO2IC,               0x5002801C,__WRITE      );
...
__IO_REG32(		 GPIO3IC,               0x5003801C,__WRITE      );
...
__IO_REG32(		 I2C0CONCLR,            0x40000018,__WRITE      );
...
__IO_REG16(    TMR16B0CR1,            0x4000C030,__READ);
...
__IO_REG16(    TMR16B1CR1,            0x40010030,__READ);
...
__IO_REG32(    TMR32B0CR1,            0x40014030,__READ);
...
__IO_REG32(    TMR32B1CR1,            0x40018030,__READ);
...
__IO_REG32(		 WDFEED,                0x40004008,__WRITE      );
